...
@router.get("/chat-casual/bienvenida")
async def bienvenida():
    return {
        "mensaje": "¡Hola! Soy Cuali, tu asistente para dar una buena educación. ¿En qué te puedo ayudar hoy?"
    }
...
async def enviar_mensaje(request: MensajeRequest):
    try:
        ...
        return {"respuesta": respuesta, "mensaje_usuario": request.mensaje}
    except httpx.ReadTimeout:
        return {"respuesta": "Lo siento, el servidor esta tardando mucho. Intenta de nuevo.", "mensaje_usuario": request.mensaje}
    except Exception as e:
        print(f"Error en chat: {str(e)}")
        return {"respuesta": "Hola, soy Cuali. Estoy teniendo problemas de conexion. Como puedo ayudarte?", "mensaje_usuario": request.mensaje}
